...
ITU is located at the Places des Nations (Square of Nations), which is a stop on many bus lines and the main tramline 15. 
The recommended hotels that are close to ITU or close to a stop on the tramline 15 (or a direct bus to Place des nations) are:
...
Upon arrival at the Geneva airport, in the baggage hall, there next to the exit point there are machines that give out free public transport tickets. 
These machines give out tickets that are valid on all public transport in Geneva for 80 minutes (trams, buses, trains, boats).

The easiest way to get to Geneva city from the airport to the city is using the trains that depart from the airport. 
All trains go via Geneva main station, which is the first stop, called Genève-Cornavin (~7 minutes).

## Contact
If you have any questions, please contact the organizing committee at hes2020@homomorphicencryption.org 
or the HomomorphicEncryption.org steering committee at contact@homomorphicencryption.org. 
